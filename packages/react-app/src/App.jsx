...
const initialNetwork = NETWORKS.arbitrum; // <------- select your target frontend network (localhost, rinkeby, xdai, mainnet)
...
function App(props) {
  ...
  useEffect(() => {
    async function getAddress() {
      if (userSigner) {
        console.log("UserSigner changed");
        const newAddress = await userSigner.getAddress();
        setAddress(newAddress);
        console.log("UserSigner changed", newAddress);
      }
    }
    getAddress();
  }, [userSigner]);
